...
- `!remove [имя файла]` - для удаления модуля
...
## **6. Логирование**
Бот использует систему логирования Python. Все логи сохраняются в файл `bot.log` и выводятся в консоль.
Формат логов:
```
...
Для управления модулями используйте команды:
- `!add module.py` - добавить модуль
- `!remove module.py` - удалить модуль  
- `!update` - перезагрузить все модули
- `!modules` - список модулей

Модули автоматически сохраняются в файл `modules.txt` и загружаются при следующем запуске.
...
7. **Логирование**: Используйте встроенную систему логирования.
